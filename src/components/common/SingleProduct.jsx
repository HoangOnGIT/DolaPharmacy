...
const SingleProduct = ({ product }) => {
    ...
    const discountedPrice = hasDiscount ? product.discountedPrice : product.basePrice;

    return (
        <div className="bg-white rounded-lg shadow-md w-64 flex-shrink-0 p-4 flex flex-col items-center text-center relative cursor-pointer group">
            {/* Discount Badge */}
            {hasDiscount && (
            ...
            {/* Buy Button */}
            <button className="cursor-pointer bg-blue-500 hover:bg-[#5dac46] transition-colors duration-300 text-white font-bold py-2 px-4 rounded-lg flex items-center focus:outline-none">
