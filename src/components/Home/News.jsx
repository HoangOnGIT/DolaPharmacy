...
const News = () => {
    const content = [
        {
            img: img2,
            header: "Bà bầu uống nước ép rau má được không? Rau má có tác dụng gì cho bà bầu?",
            title: "Bà bầu uống nước ép rau má được không? Rau má có tác dụng gì cho bà bầu",
        ...
        {
            img: img4,
            header: "Uống sắt đi ngoài màu đen có nguy hiểm không? Cách phòng ngừa tình trạng thiếu sắt",
            title: "Uống sắt đi ngoài màu đen có nguy hiểm không? Cách phòng ngừa tình trạng thiếu sắt",
            desc: "Uống sắt đi ngoài màu đen liệu có gây ảnh hưởng xấu gì đến sức khỏe hay..."
        },
        {
            img: img5,
            header: "Thai 13 tuần uống nước dừa được không? Lợi ích của nước dừa với mẹ bầu",
            title: "Thai 13 tuần uống nước dừa được không? Lợi ích của nước dừa với mẹ bầu",
            desc: "Nước dừa là thức uống rất phổ biến ở Việt Nam, có thể dễ dàng tìm mua và..."
        },
        {
            img: img6,
            header: "Chú ý cách sử dụng muối tắm để đạt hiệu quả và an toàn cho sức khỏe",
            title: "Chú ý cách sử dụng muối tắm để đạt hiệu quả và an toàn cho sức khỏe",
            desc: "Muối tắm là sản phẩm được làm từ các loại muối khoáng và muối biển nguyên..."
        },
        {
            img: img7,
            header: "Tinh dầu bưởi đem lại lợi ích gì cho da và tóc? Cách làm tinh dầu bưởi đơn giản",
            title: "Tinh dầu bưởi đem lại lợi ích gì cho da và tóc? Cách làm tinh dầu bưởi đơn giản",
            desc: "Rau má từ lâu đã nổi tiếng với nhiều công dụng như giải nhiệt, đẹp da, cải..."
        },
        {
            img: img8,
            header: "Tắm vỏ bưởi mang lại những lợi ích gì? Gợi ý cách tắm vỏ bưởi đơn giản",
            title: "Tắm vỏ bưởi mang lại những lợi ích gì? Gợi ý cách tắm vỏ bưởi đơn giản",
                ...
                <div className='flex'>
                    <div className='w-[50%]'>
                        ...
                        <h3 className='my-2 text-xl font-semibold text-gray-800 hover:text-blue-600 transition duration-300'>
                            <a href="" title="Trẻ uống kẽm có bị táo bón không? Cần lưu ý gì khi bổ sung kẽm cho bé">
                                Trẻ uống kẽm có bị táo bón không? Cần...
                            </a>
                        </h3>
                        <p className='text-sm text-blue-500 mt-1'>Ngày đăng: 18/07/2023</p>
                        <p className='text-gray-700 text-sm mt-2 leading-relaxed'>
                            Tại Việt Nam, tỷ lệ trẻ em bị thiếu kẽm lên đến 40% khiến bé chậm lớn, biếng ăn
                            , thiếu sức đề kháng. Mặc dù vậy,
                            việc bổ sung kẽm cho bé thông qua các loại thực phẩm chức năng,...
                        </p>
                    </div>
