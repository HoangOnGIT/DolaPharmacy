        ...
        <div className="header h-46 bg-gradient-to-b from-[#7fadff] to-[#0f62f9] text-white mx-auto w-full">
          ...
          <div className='w-full mx-auto ml-50'>
            ...
            <div className="container w-4/5">
              <div className='flex justify-between text-base font-semibold'>
                ...
                <div className='my-1 flex items-center'>
                  ...
                  <p className='mx-1 flex items-center' href="">Hotline đặt hàng:
                    <button
                      className="flex items-center bg-blue-800 text-white px-2.5 py-1 rounded-full text-base hover:bg-white hover:text-blue-800 ml-2 cursor-pointer">
            ...
            <div className="flex items-center my-1">
              ...
              {/* Category */}
              <button onClick={() => setIsModalOpen(!isModalOpen)} className='flex items-center bg-white px-6 py-3 text-xl text-black rounded-lg font-medium cursor-pointer hover:bg-blue-800 hover:text-white mr-10'>
                <div className='mr-2'>
